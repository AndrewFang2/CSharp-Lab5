    ...
    public class AnswerImagesController : Controller
    {
        ...
        */
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var answerImage = await _context.Images.FindAsync(id);
            if (answerImage == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var answerImage = await _context.Images
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, Question q)
        {
            ...
            try
            {
                ...
                _context.Images.Remove(answerImage);
                await _context.SaveChangesAsync();
        ...
        {
            return _context.Images.Any(e => e.AnswerImageId == id);
        }
    }
}